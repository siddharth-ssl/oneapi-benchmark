  ...
  auto advect_blocks_d3q27 = [&](sycl::handler& h) {
    h.parallel_for(sycl::nd_range<3>(threads, wg), [=](sycl::nd_item<3> it) {
      ...
      if (0 == x) {
        for (size_t g = 0; g < NG; g++) {
          for (size_t m = 0; m < NM; m++) {
            b[idx(m,x,y,z,g,npx,npy,npz)] = b_neg_ngb[idx(m,npx-(np+1),y,z,g,npx,npy,npz)];
          }
        }
      }
      ...
      if (npx-1 == x) {
        for (size_t g = 0; g < NG; g++) {
          for (size_t m = 0; m < NM; m++) {
            b[idx(m,x,y,z,g,npx,npy,npz)] = b_plus_ngb[idx(m,np,y,z,g,npx,npy,npz)];
          }
        }
      }
      ...
      if (0 == y) {
        for (size_t g = 0; g < NG; g++) {
          for (size_t m = 0; m < NM; m++) {
            b[idx(m,x,y,z,g,npx,npy,npz)] = b_neg_ngb[idx(m,x,npy-(np+1),z,g,npx,npy,npz)];
          }
        }
      }
      ...
      if (npy-1 == y) {
        for (size_t g = 0; g < NG; g++) {
          for (size_t m = 0; m < NM; m++) {
            b[idx(m,x,y,z,g,npx,npy,npz)] = b_plus_ngb[idx(m,x,np,z,g,npx,npy,npz)];
          }
        }
      }
      ...
      if (0 == z) {
        for (size_t g = 0; g < NG; g++) {
          for (size_t m = 0; m < NM; m++) {
            b[idx(m,x,y,z,g,npx,npy,npz)] = b_neg_ngb[idx(m,x,y,npz-(np+1),g,npx,npy,npz)];
          }
        }
      }
      ...
      if (npz-1 == z) {
        for (size_t g = 0; g < NG; g++) {
          for (size_t m = 0; m < NM; m++) {
            b[idx(m,x,y,z,g,npx,npy,npz)] = b_plus_ngb[idx(m,x,y,np,g,npx,npy,npz)];
          }
        }
      }
